 ...
 * AboutPage Component
 * 
 * This component displays an "About Me" section that includes information about me, 
 * my location, and my hobbies. The section also includes a profile image, a short description 
 * about myself, and a list of hobbies with corresponding icons.
 * 
 * Dependencies:
 * - React
 * - ReactComponent for importing SVG icons
 * 
  ...
  return (
    <div id="about" className="about">
      ...
      <div className="about-content">
        {/* Profile image of the individual */}
        ...
        <div className="about-text-container">
          ...
          {/* Section displaying hobbies */}
          <div className="hobbies">
            <div className="hobbies-top">
              {/* OSX-style dot container (for design purposes) */}
            ...
            <div className="hobbies-text-container">
              {/* List of hobbies with respective icons */}
